...
export default function TaskBoard() {
  ...
  return (
    <div class="container">
      ...
      Se añade el tipo del boton submit
      */
      }
      <div class="mb-6">
        <button
      ...
      {isLoading.value && !tasks.value.length
        ...
        : (
          <div class="task-board">
            {
              //Se cambian el estado y la tarea, de "TaskStatus.TODO" a "TaskStatus.PENDING"
            }
            <TaskColumn
              title="Pending"
            ...
            {
              //Se cambian el estado y la tarea, de "TaskStatus.DONE" a "TaskStatus.COMPLETED"
            }
            <TaskColumn
              title="Completed"
