...
export default function TaskForm({
  ...
  //Se cambia TaskStatus.TODO por TaskStatus.PENDING
    ...
    <div class="form-container">
      ...
      <form onSubmit={handleSaveTask}>
        ...
        <div class="form-group">
          ...
          >
            {
              //Se cambia TaskStatus.TODO por TaskStatus.PENDING y TaskStatus.DONE por TaskStatus.COMPLETED
            }
            <option value={TaskStatus.PENDING}>Todo</option>
